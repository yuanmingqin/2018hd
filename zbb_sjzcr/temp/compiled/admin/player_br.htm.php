...
?>
	  	 <tr >
			...
			<td>
				<a id="<?php echo $this->_var['item']['id']; ?>" href="javascript:;" onclick="del(this,'br')">删除</a>
				<a href="index.php?action=player_br&op=edit&id=<?php echo $this->_var['item']['id']; ?>&page=<?php echo $this->_var['page']; ?>">编辑</a>
			</td>
		</tr>
	...
	<div class="main-div">
		<input type="button" class="button" value="添加选手" onclick="javascript:location.href='index.php?action=player_br&op=add'" />
	</div>
...
<h3><?php if ($this->_var['operation'] == 'add'): ?>添加<?php else: ?>编辑<?php endif; ?>选手</h3>
	<form action="index.php?action=player_br&op=<?php echo $this->_var['operation']; ?>&page=<?php echo $this->_var['page']; ?>" method="post" onsubmit="return checkplayer(this)" enctype="multipart/form-data">
