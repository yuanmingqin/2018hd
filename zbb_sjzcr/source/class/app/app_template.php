...
class app_template
{
    ...
    function app_template()
    {
        ...
        $this->template_dir   = CUTV_ROOT.'./templates';
	    $this->cache_dir      = CUTV_ROOT.'./temp/caches';
	    $this->compile_dir    = CUTV_ROOT.'./temp/compiled';
    ...
    function select($tag)
    {
        ...
        {
            $shit_temp = explode(' ', $tag);
            $tag_sel = array_shift($shit_temp);
            switch ($tag_sel)
            {
                case 'if':
